...
class DelteStaff extends StatefulWidget {
  const DelteStaff({Key? key}) : super(key: key);

  @override
  _DelteStaffState createState() => _DelteStaffState();
}

class _DelteStaffState extends State<DelteStaff> {
  ...
  Future<void> _showDeleteConfirmationDialog(Staff staff) async {
    return showDialog(
      context: context,
  ...
  void _deleteContact(Staff staff) {
    setState(() {
